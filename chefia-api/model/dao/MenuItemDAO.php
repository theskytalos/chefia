        ...
        public function getMenuItemById($menuItemModel) {
            ...
            if ($menuItemQuery->execute()) {
                if ($menuItemQuery->rowCount() == 1) {
                    ...
                    $menuItemModel->setMenuCategoryModel(new MenuCategory($row["menu_categories_id_fk"]));
                    ...
                    $menuImageController->setMenuImagesArray($menuImageController->getAllMenuImagesByMenuItem($menuImageModel));
